...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="registration.php">REGISTER FILE</a></li>
            <li><a href="movement.php">MOVE FILE</a></li><br>
            <li> <a href="index.php">TRACK FILE</a>
            </li>
...
<div class="button">
    <form method="post">
        ...
        <input type="text" name="phone" placeholder="INPUT USER ID TO VERIFY">
